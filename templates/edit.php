                        ...
                        //$time_frames = array("07am-10am", "08am-11am", "10am-1pm", "11am-2pm", "1pm-4pm", "2pm-5pm");
                            ...
                            */
                            ...
                            if($lessons2[0] && $lessons2[1] && $lessons2[2] && $lessons2[3] && $lessons2[4] && $lessons2[5]){
                                ...
                                echo "<td>" ."</td>";
                                echo "<td>"."<input type='text' value= ". $lessons2[2] .">"."<br>"."<p>". select_lecture($lessons2[2]) ."</p>"."</td>";
                                echo "<td>" ."</td>";
                                echo "<td>" ."</td>";
                                echo "<td>" ."</td>";
                                ...
                                echo "<td>" ."</td>";
                                echo "<td>" ."</td>";
                                echo "<td>"."<input type='text' value= ". $lessons2[3] .">"."<br>"."<p>". select_lecture($lessons2[3]) ."</p>"."</td>";
                                echo "<td>" ."</td>";
                                echo "<td>" ."</td>";
                            }elseif($lessons2[1] || $lessons2[4]){
                                echo "<td>" ."</td>";
                                echo "<td>"."<input type='text' value= ". $lessons2[1] .">"."<br>"."<p>". select_lecture($lessons2[1]) ."</p>"."</td>";
                                echo "<td>" ."</td>";
                                echo "<td>" ."</td>";
                                echo "<td>"."<input type='text' value= ". $lessons2[4] .">"."<br>"."<p>". select_lecture($lessons2[4]) ."</p>"."</td>";
                                echo "<td>" ."</td>";
                            }elseif($lessons2[1]){
                                echo "<td>" ."</td>";
                                echo "<td>"."<input type='text' value= ". $lessons2[1] .">"."<br>"."<p>". select_lecture($lessons2[1]) ."</p>"."</td>";
                            ...
                            if($lessons3[0] && $lessons3[1] && $lessons3[2] && $lessons3[3] && $lessons3[4] && $lessons3[5]){
                                ...
                                echo "<td>". "<br>". $roomG ."</td>";
                                echo "<td>".  "</td>";
                                echo "<td>"."<input type='text' value= ". $lessons3[3] .">"."<br>"."<p>". select_lecture($lessons3[3]) ."</p>"."</td>";
                                echo "<td>".  "</td>";
                                echo "<td>"."<input type='text' value= ". $lessons3[5] .">"."<br>"."<p>". select_lecture($lessons3[5]) ."</p>"."</td>";

                            }elseif($lessons3[0] || $lessons3[2]){
                                echo "<td>"."<input type='text' value= ". $lessons3[0] .">"."<br>"."<p>". select_lecture($lessons3[0]) ."</p>"."</td>";
                                echo "<td>" ."</td>";
                                echo "<td>"."<input type='text' value= ". $lessons3[2] .">"."<br>"."<p>". select_lecture($lessons3[2]) ."</p>"."</td>";
                                echo "<td>" ."</td>";
                                echo "<td>" ."</td>";
                                echo "<td>" ."</td>";
                                ...
                                echo "<td>" ."</td>";
                                echo "<td>"."<input type='text' value= ". $lessons3[1] .">"."<br>"."<p>". select_lecture($lessons3[1]) ."</p>"."</td>";
                                echo "<td>" ."</td>";
                                echo "<td>" ."</td>";
                                echo "<td>"."<input type='text' value= ". $lessons3[4] .">"."<br>"."<p>". select_lecture($lessons3[4]) ."</p>"."</td>";
                                echo "<td>" ."</td>";
                            }elseif($lessons3[2]){
                                echo "<td>" ."</td>";
                                echo "<td>" ."</td>";
                            ...
                            if($lessons4[0] && $lessons4[1] && $lessons4[2] && $lessons4[3] && $lessons4[4] && $lessons4[5]){
                                echo "<td>". "</td>";
                                echo "<td>". "<br>". $roomG ."</td>";
                                echo "<td>"."<input type='text' value= ". $lessons4[2] .">"."<br>"."<p>". select_lecture($lessons4[2]) ."</p>"."</td>";
                                echo "<td>".  "</td>";
                                echo "<td>".  "</td>";
                                echo "<td>"."<input type='text' value= ". $lessons4[5] .">"."<br>"."<p>". select_lecture($lessons4[5]) ."</p>"."</td>";

                            }elseif($lessons4[0] && $lessons4[2]){
                                echo "<td>"."<input type='text' value= ". $lessons4[0] .">"."<br>"."<p>". select_lecture($lessons4[0]) ."</p>"."</td>";
                                echo "<td>" ."</td>";
                                echo "<td>"."<input type='text' value= ". $lessons4[2] .">"."<br>"."<p>". select_lecture($lessons4[2]) ."</p>"."</td>";
                                echo "<td>" ."</td>";
                                echo "<td>" ."</td>";
                                ...
                                echo "<td>" ."</td>";
                                echo "<td>" ."</td>";
                                echo "<td>"."<input type='text' value= ". $lessons4[3] .">"."<br>"."<p>". select_lecture($lessons4[3]) ."</p>"."</td>";
                                echo "<td>" ."</td>";
                                echo "<td>" ."</td>";
                            }elseif($lessons4[1] && $lessons4[4]){
                                echo "<td>" ."</td>";
                                echo "<td>"."<input type='text' value= ". $lessons4[1] .">"."<br>"."<p>". select_lecture($lessons4[1]) ."</p>"."</td>";
                                echo "<td>" ."</td>";
                                echo "<td>" ."</td>";
                                echo "<td>"."<input type='text' value= ". $lessons4[4] .">"."<br>"."<p>". select_lecture($lessons4[4]) ."</p>"."</td>";
                                echo "<td>" ."</td>";
                            }elseif($lessons4[2]){
                                echo "<td>" ."</td>";
                                echo "<td>" ."</td>";
